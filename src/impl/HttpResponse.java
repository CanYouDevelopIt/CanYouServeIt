...
public class HttpResponse implements IHttpResponse {
	 ...
	 * 
	 * @param request
	 *            Request, used to automatically determine response elements
	 * @param outputStream
	 *            Thew output stream where to write
	 */
	...
	public void write() throws IOException {
		...
		bufferedWriter.write(
				protocol + " " + status + " " + (textStatus != null ? textStatus : getTextStatusFor(status)) + "\r\n");
	...
	public enum EncodingType {
		 ...
		 * 
		 * @param outputStream
		 *            The stream to be encoded
		 * @return The encoding stream, or the provided stream is no encoding is
		 *         defined
		 * @throws IOException
		 */
