...
public class HttpServiceDownloadFile implements IHttpService {

	private File folderPath;

	public HttpServiceDownloadFile(String folderPath) throws IOException {
	...
	public void serve(IHttpRequest request, IHttpResponse response) {
		...
		if (modifiedSince != null && !fileLastModified.before(modifiedSince)) {
			...
			// getFormattedDate(resource.lastModified()));
	...
	static {
		dateFormatter = new SimpleDateFormat(HttpServiceDownloadFile.dateFormat, Locale.US);
